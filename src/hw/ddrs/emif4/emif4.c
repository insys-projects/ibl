...
SINT16 hwEmif4p0Enable (iblEmif4p0_t *cfg)
{
	...
	KICK1 = KICK1_UNLOCK;
      ...
      DATA1_WRLVL_INIT_RATIO = 0x2B;
      DATA2_WRLVL_INIT_RATIO = 0x33;
      DATA3_WRLVL_INIT_RATIO = 0x39;
      DATA4_WRLVL_INIT_RATIO = 0x3C;
      DATA5_WRLVL_INIT_RATIO = 0x4F;
      DATA6_WRLVL_INIT_RATIO = 0x53;
      DATA7_WRLVL_INIT_RATIO = 0x5A;
      DATA8_WRLVL_INIT_RATIO = 0x5D;

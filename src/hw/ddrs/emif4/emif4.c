...
SINT16 hwEmif4p0Enable (iblEmif4p0_t *cfg)
{
	...
	KICK1 = KICK1_UNLOCK;
      ...
      DATA0_WRLVL_INIT_RATIO = 0x2B;
      DATA1_WRLVL_INIT_RATIO = 0x33;
      DATA2_WRLVL_INIT_RATIO = 0x39;
      DATA3_WRLVL_INIT_RATIO = 0x3C;
      DATA4_WRLVL_INIT_RATIO = 0x4F;
      DATA5_WRLVL_INIT_RATIO = 0x53;
      DATA6_WRLVL_INIT_RATIO = 0x5A;
      DATA7_WRLVL_INIT_RATIO = 0x5D;
      DATA8_WRLVL_INIT_RATIO = 0x40;

      DATA0_GTLVL_INIT_RATIO = 0xBD;
      DATA1_GTLVL_INIT_RATIO = 0xB4;
      DATA2_GTLVL_INIT_RATIO = 0xAF;
      DATA3_GTLVL_INIT_RATIO = 0xAB;
      DATA4_GTLVL_INIT_RATIO = 0x98;
      DATA5_GTLVL_INIT_RATIO = 0x95;
      DATA6_GTLVL_INIT_RATIO = 0x8E;
      DATA7_GTLVL_INIT_RATIO = 0x8A;
      DATA8_GTLVL_INIT_RATIO = 0xA8;

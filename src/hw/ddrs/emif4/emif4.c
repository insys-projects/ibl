...
SINT16 hwEmif4p0Enable (iblEmif4p0_t *cfg)
{
	...
	KICK1 = KICK1_UNLOCK;
      ...
      DATA0_WRLVL_INIT_RATIO = 0x9E;
      DATA1_WRLVL_INIT_RATIO = 0xB7;
      DATA2_WRLVL_INIT_RATIO = 0xB2;
      DATA3_WRLVL_INIT_RATIO = 0xBC;
      DATA4_WRLVL_INIT_RATIO = 0xDE;
      DATA5_WRLVL_INIT_RATIO = 0xDF;
      DATA6_WRLVL_INIT_RATIO = 0xEF;
      DATA7_WRLVL_INIT_RATIO = 0xF5;
      DATA8_WRLVL_INIT_RATIO = 0x00;

      DATA0_GTLVL_INIT_RATIO = 0x1BC;
      DATA1_GTLVL_INIT_RATIO = 0x1A2;
      DATA2_GTLVL_INIT_RATIO = 0x1A7;
      DATA3_GTLVL_INIT_RATIO = 0x19D;
      DATA4_GTLVL_INIT_RATIO = 0x17B;
      DATA5_GTLVL_INIT_RATIO = 0x17B;
      DATA6_GTLVL_INIT_RATIO = 0x16B;
      DATA7_GTLVL_INIT_RATIO = 0x164;
